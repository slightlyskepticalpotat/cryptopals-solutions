# disregarding instruction to get the srp working in an actual client-server setting since I'm here to learn cryptography, not write flask frontends
...
# we don't need x, xH, or P we know S_server = 0
S_client = 0
